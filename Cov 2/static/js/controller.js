...
setInterval(gettime,10000*100)
setInterval(get_c1_data,10000*100)
setInterval(get_c2_data,10000*100)
setInterval(get_l1_data,10000*100)
setInterval(get_l2_data,10000*100)
setInterval(get_r1_data,10000*100)
